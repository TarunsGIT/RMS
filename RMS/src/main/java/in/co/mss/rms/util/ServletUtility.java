...
import in.co.mss.rms.controller.BaseCtl;
import in.co.mss.rms.controller.ORSView;
import in.co.mss.rms.models.AppRole;
import in.co.mss.rms.models.BaseModel;
...
public class ServletUtility {
	...
	public static void setModel(BaseModel model, HttpServletRequest request) {// BASE
																				// MODEL
	...
	public static int getPageNo(HttpServletRequest request) {
		int i = (Integer) request.getAttribute("pageNo");
		return i;
	}
	...
	public static int getPageSize(HttpServletRequest request) {
		int j = (Integer) request.getAttribute("pageSize");
		return j;
	}
