...
public class MarksheetModel {
	...
	public long add(MarksheetBean bean) throws ApplicationException,
		...
		try {
			...
			pstmt.setString(4, DataUtility.getCapital(bean.getName()));
	...
	public List getMeritList(int pageNo, int pageSize)
		...
		StringBuffer sql = new StringBuffer(
				"SELECT `ID`,`ROLL_NO`, `NAME`, `PHYSICS`, `CHEMISTRY`, `MATHS` , (PHYSICS + CHEMISTRY + MATHS) as total from `ST_MARKSHEET` WHERE (PHYSICS + CHEMISTRY + MATHS)>0  ORDER BY (PHYSICS + CHEMISTRY + MATHS) DESC");
...
/************************************ UPDATE MARKSHEET *************************************/
	...
	public void update(MarksheetBean bean) throws ApplicationException,
		...
		try {
			...
			pstmt.setString(3, DataUtility.getCapital(bean.getName()));
...
/************************************* SEARCH MARKSHEET ***********************************/
    ...
    public List list() throws ApplicationException {  //GETS LIST OF MARKSHEET
        return list(0, 0);
    }
