...
public class StudentModel {
	...
	public long add(StudentBean bean) throws ApplicationException,
		...
		CollegeBean collegeBean = cModel.findByPK(bean.getCollegeId());// USING
		bean.setCollegeName(collegeBean.getName()); // STUDENT
		// BEAN
		// OBJECt
		...
		try {
			...
			pstmt.setString(4, DataUtility.getCapital(bean.getFirstName()));
			pstmt.setString(5, DataUtility.getCapital(bean.getLastName()));
	...
	public void update(StudentBean bean) throws ApplicationException,
		...
		try {
			...
			pstmt.setString(3, DataUtility.getCapital(bean.getFirstName()));
			pstmt.setString(4, DataUtility.getCapital(bean.getLastName()));
